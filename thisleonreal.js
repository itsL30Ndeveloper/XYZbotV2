...
*Chapter Akhir* : ${komik.chapter_akhir}`
            ...
            break
            case 'asmaulhusna':
anu = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/muslim/asmaulhusna`)
...
get_result = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/kisahnabi?nabi=${q}`)
...
case 'doaharian':
anu = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/muslim/doaharian`)
           teks = `*◪* *DOA HARIAN*\n\n`
...
case 'bacaanshalat':
anu = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/muslim/bacaanshalat`)
           teks = `*╔❏* *BACAAN SHALAT*\n\n`
...
var teks = body.slice(8)
                       t1 = teks.split('|')[0]
                       t2 = teks.split('|')[1]
get_result = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/hadits?kitab=${t1}&nomor=${t2}`)
...
break
case 'tahlil':
anu = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/muslim/tahlil`)
        ...
        break
        case 'doawirid':
anu = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/muslim/wirid`)
        ...
        case 'jadwalsholat':
                    ...
                    daerah = args.join(" ")
                    get_result = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/jsholat?daerah=${daerah}`)
                    ...
                    break
                    case 'niatsholat':
anu = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/muslim/niatshalat`)
    ...
    case 'chara':
     ...
     case 'waifu':
     reply(mess.wait)
waifu = await getBuffer(`https://xyz-restapikey.herokuapp.com/api/waifu`)
xdev.sendMessage(from, waifu, image, {quoted: ftroli})
break
case 'loli':
reply(mess.wait)
loli = await getBuffer(`https://xyz-restapikey.herokuapp.com/api/loli`)
xdev.sendMessage(from, loli, image, {quoted: ftroli})
break
case 'sagiri':
reply(mess.wait)
loli = await getBuffer(`https://xyz-restapikey.herokuapp.com/api/sagiri`)
xdev.sendMessage(from, loli, image, {quoted: ftroli})
break
case 'neko':
reply(mess.wait)
loli = await getBuffer(`https://xyz-restapikey.herokuapp.com/api/neko`)
xdev.sendMessage(from, loli, image, {quoted: ftroli})
break
case 'megumin':
reply(mess.wait)
loli = await getBuffer(`https://xyz-restapikey.herokuapp.com/api/megumin`)
xdev.sendMessage(from, loli, image, {quoted: ftroli})
break
case 'nsfwneko':
reply(mess.wait)
loli = await getBuffer(`https://xyz-restapikey.herokuapp.com/api/nsfw/neko`)
xdev.sendMessage(from, loli, image, {quoted: ftroli})
break
case 'nsfwwaifu':
reply(mess.wait)
loli = await getBuffer(`https://xyz-restapikey.herokuapp.com/api/nsfw/waifu`)
xdev.sendMessage(from, loli, image, {quoted: ftroli})
break
case 'wallpaperanime':
reply(mess.wait)
loli = await getBuffer(`https://xyz-restapikey.herokuapp.com/api/wpnime`)
xdev.sendMessage(from, loli, image, {quoted: ftroli})
break

case 'husbu':
reply(mess.wait)
tod = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/husbu`)
tid = await getBuffer(tod.url)
xdev.sendMessage(from, tid, image, {quoted: ftroli})
break
case 'quotes':
reply(mess.wait)
tod = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/randomquote`)
reply(tod.quote.quotes)
break
case 'faktaunik':
reply(mess.wait)
tod = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/fakta`)
reply(tod.result)
break
case 'quotesbucin':
reply(mess.wait)
bucin = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/katabucin`)
reply(bucin.result)
break
case 'quotesmuslim':
reply(mess.wait)
tod = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/randomquote/muslim`)
reply(tod.result.text_id)
break
case 'quoteskanye':
reply(mess.wait)
tod = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/quotes/kanye`)
reply(tod.result.text_id)
break

case 'wallpaper':
reply(mess.wait)
tod = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/random/wallpaper`)
...
tod = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/tiktod/stalk/?username=${q}`)
tid = tod.result.user
...
anu = await fetchJson(`https://xyz-restapikey.herokuapp.com/api/google?q=${q}`)
...
titid = await getBuffer(`https://xyz-restapikey.herokuapp.com/api/canvas/${command}?url=${anu}`)               
...
xdev.sendMessage(from,'Nih Kak Creator XYZTeam',text,{quoted: hehe})
break
case 'style':
...
break
  ...
  case 'ping':
    ...
    reply(mess.wait)
    tod = await getBuffer(`https://xyz-restapikey.herokuapp.com/api/nulis?text=${q}`)
